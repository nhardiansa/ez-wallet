  ...
  return (
    <>
      ...
      <section className={`app-show ${style.bgWhiteGreen} py-5 px-3`}>
        <h2 className='text-center fw-bolder mb-4 mb-md-5 d-lg-none'>All The <span className='text-primary'>Great</span> EZ Wallet Features.</h2>
        <div className="row align-items-center px-lg-5 mt-lg-4">
          ...
          <div className="col-12 col-md-6">
            <h2 className='fw-bolder mb-4 fs-1 d-none d-lg-block'>All The <span className='text-primary'>Great</span> <br /> EZ Wallet Features.</h2>
