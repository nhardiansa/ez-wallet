...
export default function InputAmount() {
  ...
  const { transferAmount, balanceLeft, dateTime, notes, loading } =
    transactionReducer;
  ...
  const confirmTransaction = () => {
    if (currentBalance < transferAmount) {
      alert(
        "Insufficient balance, maximum transfer amount is Rp" +
          ...
          {!confirm ? (
            <div className="input-amount mt-5">
              <p className="text-gray">
                ...
                <br className="d-none d-md-block" /> press continue to the next
                steps.
              </p>
              ...
              <div className="input-wrapper d-flex flex-column align-items-center mb-3">
                ...
                <p className="current-balance fw-bold mt-3">
                  Rp{Number(currentBalance).toLocaleString("id-ID")} Available{" "}
                </p>
            ...
            <>
              <div className="confirm-section mt-5 h-100">
                <h2 className="fs-5 fw-bold text-center text-md-start mb-4">
                  Details
                </h2>
        ...
        modalBody={
          <>
            <p className="text-gray mb-5">
              ...
              <br className="d-none d-md-block" /> continue{" "}
              <br className="d-md-none" /> transferring money.
            </p>
            <OtpInput
